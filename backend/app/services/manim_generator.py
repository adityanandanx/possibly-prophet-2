...
class ManimCodeGenerator:
    ...
    def generate_manim_code(
        ...
        result = self._agent.generate_presentation(educational_script, style_options)

        code = result.get("manim_code", "")
        logger.info(
            f"Agent generated {result['metadata']['total_slides']} slides, "
    ...
    def generate_presentation(
        ...
        """
        return self._agent.generate_presentation(educational_script, style_options)
