...
class ContentResponse(BaseModel):
    ...
    # New pipeline fields
    video_url: Optional[str] = Field(None, description="URL to generated video (S3)")
    video_path: Optional[str] = Field(None, description="Local path to generated video")
    fda: Optional[Dict[str, Any]] = Field(None, description="FDA (Formal Description of Animation) specification")
    pipeline_metadata: Optional[Dict[str, Any]] = Field(None, description="Pipeline execution metadata")
