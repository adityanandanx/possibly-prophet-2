...
class BaseEducationalAgent:
    ...
    def process_content(self, content: str, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return self.circuit_breaker.call(
                self._process_content_with_retry,
                content,
                context
            )
    ...
    def _process_content_with_retry(self, content: str, context: Optional[Dict[str, Any]]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            try:
                ...
                logger.error(f"{self.agent_type} agent timed out after {self.timeout_seconds}s")
            ...
            logger.error(f"Error processing content with {self.agent_type} agent: {str(e)}")
            raise AgentExecutionError(
