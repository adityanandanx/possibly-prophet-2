...
class ContentService:
    ...
    async def generate_from_file(
        ...
        try:
            ...
            if "educational_script" in result and result["educational_script"]:
                result["educational_script"]["metadata"] = result[
                    "educational_script"
                ].get("metadata", {})
    ...
    async def generate_from_url(
        ...
        try:
            ...
            if "educational_script" in result and result["educational_script"]:
                ...
                result["educational_script"]["metadata"]["content_length"] = len(
                    processed_content
                )
                result["educational_script"]["metadata"][
                    "url_validation"
    ...
    async def render_video(
        ...
        try:
            ...
            # Check if Manim code exists
            manim_result = generation.get("manim_code")
            if not manim_result:
                raise ValueError(
